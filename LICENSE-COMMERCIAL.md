# Commercial License for Starship OS

**Starship OS**[](https://github.com/AbsolutionAI/starship-os) is dual-licensed.
...
- Royalty-free or revenue-share options for deployment
- Priority support and updates
- White-label / reseller rights (with approval)
- IP indemnification and warranties

This dual-licensing model allows open collaboration on the core while protecting Absolution Studios’ investment in specialized manufacturing intelligence.

For the full commercial terms, see [COMMERCIAL.md](COMMERCIAL.md).
